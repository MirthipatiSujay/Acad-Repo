  ...
  return (
    <div className="flex-1 flex items-center justify-center p-4 py-12">
      <div className="glass-panel w-full max-w-md p-8 rounded-2xl relative overflow-hidden">
        ...
        {/* Decorative elements */}
        <div className="absolute -top-10 -right-10 w-40 h-40 bg-teal-500/20 rounded-full blur-[40px] pointer-events-none" />
        <div className="absolute -bottom-10 -left-10 w-40 h-40 bg-purple-500/20 rounded-full blur-[40px] pointer-events-none" />

        <div className="relative z-10">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-white mb-2">Join AcadRepo</h1>
            <p className="text-slate-400 text-sm">Start collaborating with top Indian universities</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium text-slate-300">University / College Name</label>
              <input 
                type="text" 
                name="university"
              ...
              />
              <p className="text-xs text-slate-500">Type your college name. It will automatically appear in the platform filters.</p>
            </div>
